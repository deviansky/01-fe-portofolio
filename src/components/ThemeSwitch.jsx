...
export default function ThemeSwitch() {
  ...
  return (
    ...
    >
      {/* Track slider untuk Desktop */}
      <span className="theme-switch-track desktop-only-switch" aria-hidden="true">
      ...
      {/* Tombol ikon persegi 36x36 untuk Mobile (matahari terang / bulan gelap) */}
      <span className="theme-switch-mobile-icon mobile-only-switch" aria-hidden="true">
        {isDark ? (
